...
# This will not work as expected because the model do not TypedDict with langchain_google_genai 	


#                         TypedDict ✅	    BaseModel ✅	                Notes
# langchain_openai	         ✅ Yes	           ✅ Yes	           Both are supported
# langchain_google_genai	 ❌ No	           ✅ Yes               Only BaseModel works