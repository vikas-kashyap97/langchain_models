...
class Review(BaseModel):
    ...
    name: Optional[str] = Field(default=None , description="Write the name of the reciever")
...
# This will work as expected because the model do work Basemodel with langchain_google_genai 	
